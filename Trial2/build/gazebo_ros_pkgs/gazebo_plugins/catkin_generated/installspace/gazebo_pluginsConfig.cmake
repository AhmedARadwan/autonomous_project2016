...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ahmed/autoProject/Trial2/install/${idir}'.  Ask the maintainer 'Jose Luis Rivero <jrivero@osrfoundation.org>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ahmed/autoProject/Trial2/install/lib;/home/ahmed/catkin_ws5/devel/lib;/home/ahmed/catkin_ws4/devel/lib;/opt/ros/jade/lib)
